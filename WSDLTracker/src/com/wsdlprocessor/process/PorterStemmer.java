...
public class PorterStemmer
{
	...
	public void applyPorterStemmerToFile(File _inputFile) throws WSDLTrackerException{
		try {
			InputStream in = new FileInputStream(_inputFile);
			...
			while(true) {
				...
				if (Character.isLetter((char) ch)) {
					this.add(Character.toLowerCase((char) ch));
				}
				else {
					this.stem();
			...
			throw new WSDLTrackerException(e, this.getClass().getName(), 
					"applyPorterStemmerToFile", Level.FATAL);
		}
	}
